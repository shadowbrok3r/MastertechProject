...
pub struct Throbber<'a> {
    ...
    throbber_set: crate::terminal_mode::widgets::throbber_widgets_tui::symbols::throbber::Set,
    use_type: crate::terminal_mode::widgets::throbber_widgets_tui::symbols::throbber::WhichUse,
}
...
impl Default for Throbber<'_> {
    fn default() -> Self {
        Self {
            ...
            throbber_set: crate::terminal_mode::widgets::throbber_widgets_tui::symbols::throbber::BRAILLE_SIX,
            use_type: crate::terminal_mode::widgets::throbber_widgets_tui::symbols::throbber::WhichUse::Spin,
        }
    }
}
...
impl<'a> Throbber<'a> {
    ...
    pub fn throbber_set(mut self, set: crate::terminal_mode::widgets::throbber_widgets_tui::symbols::throbber::Set) -> Self {
        self.throbber_set = set;
        self
    }

    pub fn use_type(mut self, use_type: crate::terminal_mode::widgets::throbber_widgets_tui::symbols::throbber::WhichUse) -> Self {
    ...
    pub fn to_symbol_span(&self, state: &ThrobberState) -> ratatui::text::Span<'a> {
        let symbol = match self.use_type {
            crate::terminal_mode::widgets::throbber_widgets_tui::symbols::throbber::WhichUse::Full => self.throbber_set.full,
            crate::terminal_mode::widgets::throbber_widgets_tui::symbols::throbber::WhichUse::Empty => self.throbber_set.empty,
            crate::terminal_mode::widgets::throbber_widgets_tui::symbols::throbber::WhichUse::Spin => {
...
impl ratatui::widgets::StatefulWidget for Throbber<'_> {
    ...
    fn render(
        ...
        // render a symbol.
        let symbol = match self.use_type {
            crate::terminal_mode::widgets::throbber_widgets_tui::WhichUse::Full => self.throbber_set.full,
            crate::terminal_mode::widgets::throbber_widgets_tui::WhichUse::Empty => self.throbber_set.empty,
            crate::terminal_mode::widgets::throbber_widgets_tui::WhichUse::Spin => {
                state.normalize(&self);
                let len = self.throbber_set.symbols.len() as i8;
                if 0 <= state.index && state.index < len {
                    self.throbber_set.symbols[state.index as usize]
...
mod tests {
    ...
    fn throbber_converts_to_span() {
        let throbber = Throbber::default().use_type(crate::terminal_mode::widgets::throbber_widgets_tui::WhichUse::Full);
