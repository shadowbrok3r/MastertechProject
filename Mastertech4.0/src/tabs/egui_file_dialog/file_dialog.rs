use crate::tabs::egui_file_dialog::config::{
...
use crate::tabs::egui_file_dialog::create_directory_dialog::CreateDirectoryDialog;
use crate::tabs::egui_file_dialog::data::{
    DirectoryContent, DirectoryContentState, DirectoryEntry, DirectoryFilter, Disk, Disks,
    UserDirectories,
};
use crate::tabs::egui_file_dialog::modals::{FileDialogModal, ModalAction, ModalState, OverwriteFileModal};
use crate::tabs::egui_file_dialog::{FileSystem, NativeFileSystem};
        ...
        match &self.mode {
            ...
            DialogMode::PickMultiple => {
                let result: Vec<PathBuf> = self
                    .selected_entries()
                    .map(crate::tabs::egui_file_dialog::DirectoryEntry::to_path_buf)
                    .collect();
    ...
    fn is_selection_valid(&self) -> bool {
        match &self.mode {
            DialogMode::PickDirectory => self
                .selected_item
                .as_ref()
                .is_some_and(crate::tabs::egui_file_dialog::DirectoryEntry::is_dir),
