...
impl MastertechContext {
            ...
            ui.vertical_centered_justified(|ui| {
                ...
                ui.vertical_centered(|ui| {
                    ui.group(|ui| {
                        ...
                        ui.add_space(10.);
                        self.device_info_grid(ui);
                    });
                });

                ui.vertical_centered(|ui| {
                    ui.group(|ui| {
                        self.recommendations_grid(ui);
                        ui.add_space(10.);
                        self.seb_info_grid(ui);
                    });
                });
        ...
        ui.vertical_centered(|ui| {
            ui.group(|ui| {
                    ...
                    .show(ui, |ui| 
                {
                    ...
                    ui.vertical_centered(|ui|  {
                        ComboBox::from_id_salt("ram_cbox").width(140. - 5.0)
    ...
    fn device_info_grid(&mut self, ui: &mut Ui) {
        Grid::new("Device Details Grid")
            ...
            .min_col_width(140. * 2.0)
            .max_col_width(140. * 2.1)
            .num_columns(2)
            .show(ui, |ui| 
        {
