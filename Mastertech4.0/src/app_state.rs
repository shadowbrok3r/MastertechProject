...
pub struct MastertechContext {
    ...
    pub show_terminal_viewport: Arc<AtomicBool>,
    pub embedded_terminal: Option<crate::terminal_mode::embedded::EmbeddedTerminal>,
    pub stress_test: crate::tabs::stress_test::StressRunner,
    ...
    pub shopify_orders_tab: crate::tabs::shopify_orders::ShopifyOrdersTab,
...
impl MasterTechApp {
    ...
    pub fn new(cc: &eframe::CreationContext<'_>) -> Self {
        ...
        let mastertech_context = MastertechContext {
            ...
            show_terminal_viewport: Arc::new(AtomicBool::new(false)),
            embedded_terminal: None,
            stress_test: crate::tabs::stress_test::StressRunner::default(),
            ...
            shopify_orders_tab: crate::tabs::shopify_orders::ShopifyOrdersTab::default(),
            progress: (0.0, 0.0),
