...
use crate::styling::{APP_BACKGROUND, THEME};
...
impl DropdownMenu {
    ...
    /// Per-item row rects inside the panel after render, paired with the index.
    pub fn item_rects(&self) -> Vec<(Rect, usize)> {
