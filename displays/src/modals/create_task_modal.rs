...
use eframe::egui::{
    Align, Button, Color32, ComboBox, Direction, FontId, Layout, Margin, RichText, Stroke,
                    ...
                    if let Some(users) = &mut self.store_users {
                        ...
                        ComboBox::new("AssigneeComboBox", "")
                            .selected_text(
                                self.assignee
                                    .as_ref()
                                    .unwrap_or(users.get(0).as_ref().unwrap())
                                    .everest_initials
                                    .clone(),
                            )
                            .show_ui(ui, |ui| {
...
impl Tur {
    ...
    pub fn tur_sheet(&mut self, ui: &mut Ui) {
        ...
        Grid::new("ticket_info_grid")
            ...
            .show(ui, |ui| {
                ...
                if let Some(users) = &self.store_users {
                    ...
                    let _result =
                        AutoCompleteTextEdit::new(&mut self.ticket_data.salesman, inputs.clone())
                    ...
                    let _result =
                        AutoCompleteTextEdit::new(&mut self.ticket_data.tech, inputs.clone())
                            .highlight_matches(true)
                            .max_suggestions(3)
                            .set_text_edit_properties(move |text_edit| {
                                text_edit
        ...
        let button2 = Button::new(RichText::new("Submit TUR").color(txt_color))
        ...
        let button3 =
            Button::new(RichText::new("Master-Tech.app")).min_size(Vec2::new(width, 20.0));
