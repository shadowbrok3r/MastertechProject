...
use eframe::egui::{Button, CentralPanel, ComboBox, TextEdit, Ui, Widget};
...
impl SalesTracker {
	pub fn ui(&mut self, ui: &mut Ui) {
		eframe::egui::Panel::top("SalesTopPanel").show(ui, |ui| {
			ui.horizontal(|ui| {
				// search box
		...
		// summary footer
		eframe::egui::Panel::bottom("SalesBottom").show(ui, |ui| {
			ui.columns(9, |ui| {
