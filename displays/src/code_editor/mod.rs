...
impl CodeEditor {
    ...
    pub fn format(&self, ty: TokenType) -> eframe::egui::text::TextFormat {
        let font_id = eframe::egui::FontId::monospace(self.fontsize);
        let color = self.theme.type_color(ty);
        eframe::egui::text::TextFormat::simple(font_id, color)
    }

    
    fn numlines_show(&self, ui: &mut eframe::egui::Ui, text: &str) {
        ...
        ui.add(
            eframe::egui::TextEdit::multiline(&mut counter)
    ...
    /// Show Code Editor
    pub fn show(&mut self, ui: &mut eframe::egui::Ui, text: &mut dyn eframe::egui::TextBuffer) -> TextEditOutput {
        let mut text_edit_output: Option<TextEditOutput> = None;
        let mut code_editor = |ui: &mut eframe::egui::Ui| {
            ui.horizontal_top(|h| {
