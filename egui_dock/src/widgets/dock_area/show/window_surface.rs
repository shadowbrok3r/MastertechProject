use egui::{
    vec2, Align, Color32, CursorIcon, Frame, Layout, Rect, Response, RichText, CornerRadius, Sense,
...
impl<Tab> DockArea<'_, Tab> {
    ...
    fn window_expand(
        ...
        let color = if response.hovered() || response.has_focus() {
            ui.painter()
                .rect_filled(rect, CornerRadius::ZERO, style.buttons.minimize_window_bg_fill);
