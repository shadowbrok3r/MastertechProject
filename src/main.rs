        ...
        CentralPanel::default()
            ...
            if self.active_tab == 0 {
                StripBuilder::new(ui)
                    ...
                    .size(Size::relative(0.25)) // bottom strip
                    .vertical(|mut strip| {
                        strip.strip(|builder| {
                            builder.sizes(Size::remainder(), 2).horizontal(|mut strip| {
                                strip.cell(|ui| {
                                    
                                    // Background color for Top Left cell
                                    ...
                                    ui.horizontal(|ui| {
                                        ...
                                        .hint_text("SO#").char_limit(8).vertical_align(Align::Center).desired_width(self.widget_size));
