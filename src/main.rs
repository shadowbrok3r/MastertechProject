...
use std::{path::PathBuf, thread::JoinHandle, sync::{mpsc, Arc, Mutex}, collections::HashSet, env}; //, os::windows::thread};
use sysinfo::*; 
use eframe::egui;
...
fn new_worker(on_done_tx: mpsc::SyncSender<()>, open: bool,) 
...
impl MastertechContext {
    fn spawn_thread(&mut self) {
        ...
        self.threads
            .push(new_worker(self.on_done_tx.clone(), self.open));
    }
